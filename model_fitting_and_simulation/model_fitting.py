...
if __name__ == "__main__":  
    ...
    # Save data frame: (Note, data is already saved in data folder)
    ## Main experiment
    # delta_df.to_csv('data/main_experiment/deltas.csv', index=False)
    ## Pilot experiment
    #delta_df.to_csv('data/pilot/deltas_pilot.csv', index=False)
